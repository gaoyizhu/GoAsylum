  ...
  return (
    <div className="min-h-screen bg-background flex items-start justify-center p-6 relative">
      ...
      <div className="fixed top-2 right-2 md:top-4 md:right-4 z-50 flex flex-col md:flex-row gap-1.5 md:gap-3">
        ...
        >
          <img 
            src="https://private-us-east-1.manuscdn.com/sessionFile/oZItJG8Pi4pSg6byyTzLUB/sandbox/UmzOUCEIpUGALyXS8CZIdv_1771419452849_na1fn_ZmVlLWljb24tdHJhbnNwYXJlbnQ.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=prJiqgi90qCyGC~3V~8yOVnKiVAPejImkM2NO0fidhs9w5IL-38o-CcofTTtI49oh8EBL2mx2u9dAFA1mCvn-PLphcX079ZZWZQ0z5AF4yDUgp3y4JXJYSxBqofHmZu9zIr5VP6k8UNghxZWSZoOmj0-uQCaIehLJZUwAXDS4~exoa6jUtEq61gkmbKQWLJN9SKKc-p~3hLueaKVGiBJuVKTC6UiQlFOmdNBQKSv4GOs1DDgxSMXVsydKLfwS4ktQtpPMIn7mcfL1Wmyj8P3mZW7MlcGaDzzoROzWWVa~jxyW3gmUUvtOy7VipfBJEbXlXXpoh-mzWihVviFxz1LZw__"
            alt="诊费" 
            className="w-8 h-8 md:w-11 md:h-11"
          />
