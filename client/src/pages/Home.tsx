    ...
    <div className="min-h-screen bg-background flex items-start justify-center p-6 relative">
      ...
      <div className="flex flex-col items-center justify-start w-full max-w-md gap-5 pt-0 pb-24">
        ...
        <div className="flex flex-row gap-4 mt-1 w-full justify-center items-end">
          ...
          >
            <img 
              src="https://private-us-east-1.manuscdn.com/sessionFile/oZItJG8Pi4pSg6byyTzLUB/sandbox/9HsYmxe8JPsAg3HME475P1_1771429435507_na1fn_ZG93bmxvYWQtYXBwLWljb24tbGFyZ2U.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=Y3NUYZMyi37J7O0jBONyXWI3~qCGil3pPG99Z193b5KsuSm0a~eHMEJem5gXO81MNOvrjMV3Lq0ifQPlCwBUpK1Pt5CMPf6LwmKx98rPlast1Poh6Fxz6CgAd6I1jgUqQk87-rhlFCQ4YdFSjPGWqqHYSrH3ud8tZVuTWBwZ3Vb2Uy5MPZKHo2nAr3LipClRXU-jEIEWKynuMKDpnhWLdFu2nPFySjZk2XCayhUCfnyiKxbDcRSlU82L9t0B9MUl~jUw~vr4b6l81hSMjouy-PUgDBEeczavGnZvJTrcKefaEZjY6~-0ZzLwP5UWz5ZgBuy0zXNJBKpvIk4-ZW3Tgg__"
              alt="下载APP" 
              className="w-8 h-8"
            />
