  ...
  return (
    <div className="min-h-screen bg-background flex items-start justify-center p-6 relative">
      ...
      <div className="fixed top-2 right-2 md:top-4 md:right-4 z-50 flex flex-col md:flex-row gap-1.5 md:gap-3">
        ...
        >
          <img 
            src="https://private-us-east-1.manuscdn.com/sessionFile/oZItJG8Pi4pSg6byyTzLUB/sandbox/HBtFkW4isqa2m2eX73d5tg_1771421890134_na1fn_ZmVlLWljb24tdjI.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=G3KvObcF~2fipLxIKWgGSc29l9ME7TERpeRCfSy34WxHxvLlYa1BKeqsDi4dORLBNnMSFLiPL5f16DZ6cdVP5zF0O8~hZdeyn~xTum81u-ZP8mAAIpOwW5D~eQq1yEPCYj~J-oU9O6Nay4KP~OattP3fgPdVxSPzoSBQ5plRw-54CusTP0FwQ3bad2JJkSc0ZHzdmylKjfQbEzLKKylDmEBPycrpop9mDoTC5oe5Nl1-ufnExdthHsrjQ3pYqUtEB9yRimH0XsHkeWUey0r7335JDk8gCU196JX8geHM72iHcITwIWzXQ14UwwAh4y6qJ7HHIRE0CglNxGpgOXnISw__"
            alt="诊费" 
            className="w-8 h-8 md:w-11 md:h-11"
          />
