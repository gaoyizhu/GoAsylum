    ...
    <div className="min-h-screen bg-background flex items-start justify-center p-6 relative">
      ...
      <div className="fixed top-4 right-4 z-50 flex gap-3">
        ...
        <button
          ...
          aria-label="院长信箱"
        >
          <div className="w-14 h-14 bg-white rounded-lg shadow-md flex items-center justify-center group-hover:shadow-lg transition-shadow">
            <img 
          ...
          <span className="text-[10px] font-medium text-foreground">院长信箱</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-medium text-foreground">诊费</span>
        </button>
      </div>
