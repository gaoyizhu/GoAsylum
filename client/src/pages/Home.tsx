        ...
        <div className="flex flex-row gap-4 mt-1 w-full justify-center items-end">
          ...
          >
            <img 
              ...
              className="w-8 h-8"
            />
            <span className="text-xs font-medium text-foreground text-center w-16 leading-tight h-8 flex items-center justify-center">{t.home.directorMailbox}</span>
          </button>
          ...
          >
            <img 
              ...
              className="w-8 h-8"
            />
            <span className="text-xs font-medium text-foreground text-center w-16 leading-tight h-8 flex items-center justify-center">{t.home.downloadApp}</span>
          </button>
          ...
          >
            <img 
              ...
              className="w-8 h-8"
            />
            <span className="text-xs font-medium text-foreground text-center w-16 leading-tight h-8 flex items-center justify-center">{t.home.consultation}</span>
          </button>
        </div>
