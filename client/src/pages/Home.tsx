  ...
  return (
    <div className="min-h-screen bg-background flex items-start justify-center p-6 relative">
      ...
      <div className="fixed top-2 right-2 md:top-4 md:right-4 z-50 flex flex-col md:flex-row gap-1.5 md:gap-3">
        ...
        >
          <img 
            src="https://private-us-east-1.manuscdn.com/sessionFile/oZItJG8Pi4pSg6byyTzLUB/sandbox/0qS9cjMIsJP9zf8uFhly8G_1771424119794_na1fn_eXVhbi1pY29u.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=RWCo~Cexn8yWMTHT2hvSt2P2RilAzqWsrsD58dMgcRWRZl0y9rTU1QGX9jLGP3jf7KxqKL2vUqBz~W7ejlJ4iNOXZIbXQmoSCAArl2QNLmoDIXZ3zD9G5CTW-RcuyUJsqmhLyAL8sqM5BNDIj31sEaCaX4ONJ9nJy4bBB7yOE~58DPzdQkvJvxudRBVBsZkm1BWwZJJyh6dRSCalrldV9q8-qdj6D6kA3FFdXoLrE7baa4BTLDWzvAEWD-mjudUf6tdQmfZjyolm1ziX~ahBYI1NdDIr34F~1OyBl1dez3B3cYldGNpbOXy4e3SJ5ibhqCv4d8aqj~KnoUF64Oefmw__"
            alt="诊费" 
            className="w-8 h-8 md:w-11 md:h-11"
          />
